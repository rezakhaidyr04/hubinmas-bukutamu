    ...
    <div class="mb-6 sm:mb-8">
        <div class="flex items-center justify-between mb-3">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-0.5">Coretkan tanda tangan Anda di kotak di bawah ini</p>
            </div>
            <button 
                type="button" 
                id="clear-signature-btn"
                class="text-xs font-bold text-slate-500 hover:text-red-500 border border-slate-200 hover:border-red-300 px-3 py-1.5 rounded-lg transition-all inline-flex items-center gap-1.5"
            >
        ...
        <div class="relative border-2 border-dashed border-slate-300 rounded-2xl overflow-hidden bg-slate-50 hover:border-primary-400 transition-colors"
             id="signature-pad-wrapper"
            ...
            ></canvas>
            <div id="signature-placeholder" class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none opacity-40">
                ...
                <span class="text-xs font-medium text-slate-400">Coret di sini untuk tanda tangan</span>
            </div>
        </div>
        <div id="signature-error" class="hidden mt-2 text-xs text-red-500 font-semibold">Tanda tangan wajib diisi sebelum menyimpan.</div>
    </div>
